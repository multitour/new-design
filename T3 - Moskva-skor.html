...
<div class='content'>
	<div class='dop_kroshki clearfix'>
		<div class='dop_kroshki_ab'>
        			...
        			<div class='f-left'> / <a href="#">Туристам</a> / <a href="#">Где купить?</a> / МУЛЬТИТУР Москва (м. Сокольники) </div>
		</div>
	</div>
    ...
    <div class="collapse-button">
        ...
        <span class="icon-bar"></span>
                    ...
                    <li><span class='active'>Где купить</span></li>
                    ...
                    <li><a href="#" title="Страхование">Страхование</a></li>
		...
		<div class='content_bg wlb tourist'>
            ...
            <div class="content_tourist">
                ...
                <p><b class="header">Адрес:</b> г. Москва, ст. м. «Савёловская» , ул. Нижняя Масловка, д. 3, этаж 3, офис 36.<br/>ООО «СкорпиоТур ТК»</p>

				<p class="nospace"><b class="header">Тел.:</b> (495) 945-29-62, (495) 945-43-75</p>	
                <p><b class="header">Факс:</b> (495) 945-29-62, (495) 945-43-75</p>			

				<p><b>e-mail:</b> scorpio @ multitours.ru</p>
                <p><b>сайт:</b> <a href="http://www.scorpiotur.ru" title="СкорпиоТур ТК" target="_blank">http://www.scorpiotur.ru/</a></p>					
               

				<p class="nospace header">График работы:</p>
                
                <table class="schedule">
                	<tr>
                    	<td>понедельник-пятница: <b>09:00 - 20:00</b></td>                        
                    </tr>
                    <tr>
                   		<td>суббота: <b>11:00 -15:00</b></td>                        
                    </tr>
                    <tr>
                    	<td>воскресенье – <b>выходной</b></td>                        
                    </tr>
                </table>
                               

				<p class="header">Cхема прохода от метро</p>
                
                <div class="map">
                	<!-- Этот блок кода нужно вставить в ту часть страницы, где вы хотите разместить карту (начало) -->
<div id="ymaps-map-id_134077873446551217269" style="width: 100%; height: 450px;"></div>
<div style="width: 100%; text-align: right;"><a href="http://api.yandex.ru/maps/tools/constructor/?lang=ru-RU" target="_blank" style="color: #1A3DC1; font: 13px Arial,Helvetica,sans-serif;">Создано с помощью инструментов Яндекс.Карт</a></div>
<script type="text/javascript">function fid_134077873446551217269(ymaps) {var map = new ymaps.Map("ymaps-map-id_134077873446551217269", {center: [37.58412229364012, 55.793634345793365], zoom: 15, type: "yandex#map"});map.controls.add("zoomControl").add("mapTools").add(new ymaps.control.TypeSelector(["yandex#map", "yandex#satellite", "yandex#hybrid", "yandex#publicMap"]));map.geoObjects.add(new ymaps.Placemark([37.621875, 55.755606], {balloonContent: "Туристическая компания «ПЕРВЫМ КЛАССОМ»"}, {preset: "twirl#redDotIcon"})).add(new ymaps.Placemark([37.654745, 55.746182], {balloonContent: "ООО \"БП \"РУССКИЕ КАНИКУЛЫ\""}, {preset: "twirl#redDotIcon"})).add(new ymaps.Placemark([37.585538, 55.791552], {balloonContent: "ООО «СкорпиоТур ТК»"}, {preset: "twirl#redDotIcon"})).add(new ymaps.Polyline([[37.653564328033426, 55.742285009840465], [37.654084676582315, 55.74284182052923], [37.65455138095089, 55.74368912584118], [37.65471767790979, 55.74477849125007], [37.6547874153442, 55.746134103328686]], {balloonContent: ""}, {strokeColor: "ff0000", strokeWidth: 5, strokeOpacity: 0.5}));};</script>
<script type="text/javascript" src="http://api-maps.yandex.ru/2.0/?coordorder=longlat&load=package.full&wizard=constructor&lang=ru-RU&onload=fid_134077873446551217269"></script>
