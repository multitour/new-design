...
<title>Страхование по Прибалтике</title>
...
<div class='content'>
	<div class='dop_kroshki clearfix'>
		<div class='dop_kroshki_ab'>
			<a class='f-left home' href='/'></a>
			<div class='f-left'> / <a href="#">Туристам</a> / <a href="#">Страхование</a> / Страхование по Прибалтике</div>
		</div>
	</div>
	<div class='block-center'>		
		<div class="left_block f-left">
            <!-- Menu Tourist -->
            <div class="tourist_menu">
    ...
    <div class="collapse-button">
        ...
        <span class="icon-bar"></span>
                    ...
                    <li><a href="#" title="Где купить">Где купить</a></li>
                    <li><a href="#" title="Финансовые гарантии">Финансовые гарантии</a></li>
                    <li><a href="#" title="Способы оплаты">Способы оплаты</a></li>
                    <li><a href="#" title="Дисконтная программа">Дисконтная программа</a></li>
                    <li><a href="#" title="Акции и конкурсы">Акции и конкурсы</a></li>
                    <li><a href="#" title="Ж/д и авиа кассы">Ж/д и авиа кассы</a></li>
                    <li><span class='active'>Страхование</span></li>
                    <li><a href="#" title="Регистрация в on-line бронировании" style="margin-top:-7px;">Регистрация в on-line бронировании</a></li>
                    <li><a href="#" title="Экстренная связь">Экстренная связь</a></li>
                </ul>
            </div>
            <!-- End Menu Tourist -->
            
            <!-- insurance menu  -->
            <div class="right_block_insurance">
                <p class="header">Страхование Россия и СНГ</p>

                <p><b>+ Россия и СНГ</b></p>
                
                <ul>
                    <li>- <a href="#" title="Программа страхования В (ЭКОНОМ)">Программа страхования В (ЭКОНОМ)</a></li>
                    <li>- <a href="#" title="Программа страхования С (КЛАССИК)">Программа страхования С (КЛАССИК)</a></li>
                    <li>- <a href="#" title="Страхование багажа и отмены поездки">Страхование багажа и отмены поездки</a></li>
                </ul>
                <p><b>+ Прибалтика</b></p>

                <ul>
                    <li>- <a href="#" title="Программа страхования АльфаТревел ЭКОНОМ">Программа страхования АльфаТревел ЭКОНОМ</a></li>
                    <li>- <a href="#" title="Страхование несчастного случая и отмены поездки">Страхование несчастного случая и отмены поездки</a></li>
                </ul>
                <p><b>+ Если произошел страховой случай</b></p>
            </div>
            <!-- end insurance menu  -->
        </div>
		<div class='content_bg wlb tourist'>
        
        	
            
            <div class="content_tourist">
            	
                <h3>Страхование по Прибалтике</h3>
                <p class="header nospace">Страхование является неотъемлемой частью для туристов, получающих Шенгенскую визу.</p> 
				<p>Компания «МУЛЬТИТУР» предлагает страхование медицинских и иных непредвиденных расходов граждан, выезжающих за пределы постоянного места жительства.</p>

				<h4>Программа страхования АльфаТревел ЭКОНОМ <a name="eco"></a></h4>

				<p><b>Программа страхования АльфаТревел ЭКОНОМ предусматривает: </b></p>
                <ul class="insurance_program">
                	<li>Медицинские расходы по амбулаторному и/или по стационарному лечению;</li>
                	<li>Расходы на экстренную стоматологическую помощь;</li>
                	<li>Расходы по медицинской транспортировке;</li>
                	<li>Расходы по посмертной репатриации;</li>
                	<li>Транспортные расходы;</li>
                	<li>Расходы по оплате срочных сообщений.</li>
                </ul>
                
                <table class="insurance_program_table">
                	<tr>
                    	<th>Страховая премия<br/>(ЕВРО в день) </th>
                        <th>Страховая сумма (ЕВРО)</th>
                        <th>Сроки выплат</th>
                    </tr>                    
                    ...
                    <tr>
                    	<td>1</td>
                        <td>30 000</td>                        
                        <td style="text-align:left;">В течение 10 дней со дня установления страхового случая</td>
                    </tr>
                </table>
                
                <p><b class="header">Франшиза отсутствует.</b></p>
				<p><b class="header">Для туристов старше 70-ти лет</b> действуют тарифные надбавки</p>
                
                <br/>                
                
                <h4>Страхование несчастного случая и отмены поездки <a name="accident"></a></h4>
                
                <table class="insurance_program_table">
                	<tr>
                    	<th style="padding:25px 20px;">Страховые риски </th>
                        <th style="padding:25px 20px;">Страховая сумма</th>
                        <th style="padding:25px 20px;">Страховая премия</th>                        
                    </tr>
                                        
                    <tr>
                    	<td><b class="header">Несчастный случай</b></td>
                        <td>3 000 Euro</td>
                        <td>0,28 Euro в сутки</td>
                        
                    </tr>
                    <tr>
                    	<td><b class="header">Отмена поездки*</b></td>
                ...
                <p><a href="/content/files/docs/strahovka_pribaltika/Strahovanie_ot_neschastnogo_sluchaya.doc" title="Пункт правил страхования от несчастного случая">Пункт правил страхования от несчастного случая >>></a></p>
                <p><a href="/content/files/docs/strahovka_pribaltika/Strahovanie_otmeny_poezdki.doc" title="Страхование отмены поездки">Страхование отмены поездки >>></a></p>
                
                <p>*При оформлении страховки «Отмена поездки», программа АльфаТревел Эконом оформляется в обязательном порядке. Туристу необходимо лично от руки <a href="/content/files/docs/strahovka_pribaltika/Zayavlenie_na_strahovanie_ot_otmeny_poezdki.doc">заявление на страхование от отмены поездки</a>.</p>				

				<p><a href="/turistam/insurance" title="Если произошел страховой случай">Если произошел страховой случай</a></p>
                
                <p class="header">Выплата страхового возмещения при наступлении страхового случая осуществляется 
в течение 10 дней со дня установления обстоятельств происшествия и размера ущерба.</p>
            
           	  	<div class="attention_block">
                	<p class="header">Внимание!</p>
                    
                    <p>Для оформления страхового полиса необходимо предоставлять данные того<br/>загран. паспорта, с которым турист едет в тур.</p>

                    <p>Для оформления страхового полиса необходимо ОБЯЗАТЕЛЬНО предоставлять:</p>
                    <ul>
                        <li>Ф.И.О. туристов</li>
                        <li>дату рождения</li>
                    </ul>
					<p class="nospace">Получить страховой полис можно только в московском офисе МУЛЬТИТУР:</p>
					<p>г. Москва, ул. Шумкина, д. 20, строение 1, 2-ой этаж, на территории бизнес-центра «На Шумкина»</p>					

					<p><i>МУЛЬТИТУР не несет ответственности перед туристами, если турагентство вовремя не получило страховку в офисе компании.</i></p>
