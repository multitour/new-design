...
<title>Новости Мультитур NEW </title>
...
<div class='content'>
	<div class='dop_kroshki'>
		<div class='dop_kroshki_ab'>
			...
			<div class='f-left'>/ Новости</div>
		</div>
	</div>
	<div class='block-center'>		
		
		<div class='content_bg news_page'>
          ...
          <h1>Новости</h1>
			...
			<div class="media mt-media">
				...
				<p class="media-left col-xs-12 col-sm-2">
					<!--Медиа-объект (изображение)-->
					<a  href="#"><img class="media-object" src="img/big-photo.jpg" alt="" class="img-responsive"></a>
				</p>
				<div class="clearfix visible-xs"></div>
				<div class="media-body">
					<p class="text-muted">11.01.2015</p>
					<h4 class="media-heading">Плацкартные ж/д билеты Москва-Киев-Москва на Рождественские каникулы</h4>
					<p>Уменьшена цена плацкартных билетов на направление Москва<br/>Киев-Москва на Рождественские каникулы.</p>
			...
			<div class="media mt-media">
				...
				<p class="media-left col-xs-12 col-sm-2">
					<!--Медиа-объект (изображение)-->
					<a  href="#"><img class="media-object" src="img/big-photo.jpg" alt=""></a>
				</p>
				<div class="clearfix visible-xs"></div>
				<div class="media-body">
					<p class="text-muted">11.01.2015</p>
			...
			<div class="pager">
                    ...
                    <span class="output m_b">Всего новостей: 99</span>
