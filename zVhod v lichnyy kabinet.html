...
<div class='content'>
	<div class='dop_kroshki'>
		<div class='dop_kroshki_ab'>
			...
			<div class='f-left'> / Вход в личный кабинет</div>
		</div>
	</div>
	<div class='block-center'>
		<div class='auth'>
			<div class='auth_login'>
				<p class="name_lk">Вход в личный кабинет<br/>для частных лиц</p>
				<p class="auth_agency f-right"><a href=''>Вход для агентств</a></p>
				<div class='input clear'>
					<div class="input_left">
						<div class="input_right">
							<div class="input_center">
								<input type='text' name='user' placeholder='Логин (e-mail)' />
							</div>
						</div>
					</div>
				</div>
				...
				<div class='f-left'>
					<div class='recovery'><a href=''>Забыли пароль</a></div>
					<div class='reg'><a href=''>Регистрация</a></div>
				</div>
				<div class='f-left f-right auth_buttom'>
			...
			<div class='auth_b_text'>
				Для авторизации Вам необходимо ввести логин и пароль, полученные при регистрации в системе on-line бронирования 
			</div>
		</div> <!-- # auth -->
