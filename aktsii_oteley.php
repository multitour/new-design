...
<div class='content'>
	<div class='dop_kroshki'>
		<div class='dop_kroshki_ab f-left'>
			<a class='f-left home' href='/'></a><div class='f-left'>/ Акции отелей</div>
		</div>
	</div>
	<div class='block-center'>		
		
		<div class='content_bg offer action'>
        	
        	<div class='podbor_banners'>
				<img src="img/ban.jpg" alt='' class='img-responsive' />
			</div>
			...
			<form action='#'>
                ...
                <table class="offer_table">
                    ...
                    <tr>
                    	<td class="date">26.11.12</td>
                        <td class="hotel">
                   	    	<a href="#" title="1"><img src="img/hotel_preview.jpg" width="70" height="55" alt="1" /></a>
                            <span>
                            	<a href="#" title="Улиткино загородный отель">Улиткино загородный отель</a>
                                
								Россия
                            </span>
                        </td>
                        <td class="action cur"><a href="#" title="«Pro Корпоратив»">«Pro Корпоратив»</a></td>
                        <td class="descr">2-х местные стандартные номера в будни - 2 900 руб./сутки (при 2-х местном размещении), семейный номер в будни - 4 900 руб./сутки (при 3-х местном размещении), люкс в будни - 4 900 руб./сутки... <a href="#" title="подробнее" class="more">подробнее</a>
                        
                        	<div class="additional_descr">
                            	<div class="header">подробнее <span>close</span></div>
                                
                                <div class="body">
                                    <ul>
                                        <li><span class="name">Акция «Семейная»</span></li>
                                        <li>с 11.04.13 до 31.05.13 (кроме праздничных заездов)</li>
                                        <li>дети до 12-ти лет размещаются бесплатно на основном месте в номере с 2-мя взрослыми!</li>
                                        <li>Условия акции: акция действует при бронировании тура продолжительностью не менее 5-ти суток; cкидки не суммируются с другими акциями и спецпредложениями.</li>
                                    </ul>
                                    
                                    <ul>
                                        <li><span class="name">Акция «Простая арифметика»</span></li>
                                        <li>с 11.04.13 до 31.05.13 (кроме праздничных заездов)</li>
                                        <li>семь суток по цене шести.</li>
                                        <li>Условия акции: cкидки не суммируются с другими акциями и спецпредложениями.</li>
                                    </ul>
                                    
                                    <ul>
                                        <li><span class="name">Акция «Десятка»</span></li>
                                        <li>с 11.04.13 до 31.05.13 (кроме праздничных заездов)</li>
                                        <li>при бронировании проживания от 10-ти суток предоставляется скидка – 20%.</li>
                                        <li>Условия акции: cкидки не суммируются с другими акциями и спецпредложениями.</li>
                                    </ul>
                        ...
                        <td class="validity">26.11.12 - 28.12.12</td>
                    </tr>
                    <tr>
                    	<td class="date">26.11.12</td>
                        <td class="hotel">
