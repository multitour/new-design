...
<div class='content'>
	<div class='dop_kroshki clearfix'>
		<div class='dop_kroshki_ab'>
			...
			<div class='f-left'> / <a href="#">О компании</a></div><div class='f-left'> / Наши вакансии</div>
		</div>
	</div>
    ...
    <div class="collapse-button">
        ...
        <span class="icon-bar"></span>
                ...
                <ul>                        
                    ...
                    <li><span class='active'>Наши вакансии</span></li>
		...
		<div class='content_bg wlb company'>
            ...
            <div class="content_company">
                ...
                <div class="vacancyBlock">
                	<a href="#" title="Ведущий менеджер договорного отдела">Ведущий менеджер договорного отдела</a>
					<p>Заключение договоров со здравницами и объектами размещения</p>
                </div>
                
                <div class="vacancyBlock">
                	<a href="#" title="Специалист по поддержке ПО / Cистемный администратор">Специалист по поддержке ПО / Cистемный администратор</a>
					<p>Администрирование, настройка, развертывание БД. Поддержка работоспособности серверов с БД и ПО "Мастер-тур"</p>
                </div>
