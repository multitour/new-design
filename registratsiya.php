...
<div class='content'>
	<div class='dop_kroshki'>
		<div class='dop_kroshki_ab'>
			...
			<div class='f-left'>/ Регистрация в on-line бронировании </div>
		</div>
	</div>
	<div class='block-center'>
		<div class='auth form_registr'>
			<div class='auth_login'>
				<p class="name_lk">Форма регистрации нового часного лица</p>
						...
						<td>
							<div class='input'>
								<div class="input_left">
									<div class="input_right">
										<div class="input_center">
											<input id='customer_phone' class="data_phone" type='text' value="7" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class='auth_login_captcha f-left'>
								<div class='input'>
									<div class="input_left">
										<div class="input_right">
											<div class="input_center">
												<img src="img/auth_login_captcha.jpg" />
											</div>
										</div>
									</div>
								</div>
							</div>
							<div class='input auth_login_input f-left f-right'>
								<div class="input_left">
									<div class="input_right">
										<div class="input_center">
											<input type='text' name='name' />
				...
				<div class='auth_buttom f-right'>
					<div class="auth_buttom_left">
						<div class="auth_buttom_right">
							<div class="auth_buttom_center">
				...
				<p class="text_mini">
					* - поля, обязательные для заполнения.<br/>
 					При незаполнении полей "для обязательного заполнения" регистрация не принимается.
				</p>
			</div><!-- # auth_login -->
		</div>
		<div class="form_registr_bot">
			<div class='form_registr_bot_bg'></div>
		</div>
		<div class='auth form_registr'>
			<div class='registr_info'>
				<div class='f-left registr_info_bg'></div>
				<div class='registr_info_text'>
					<div class="name">Возможности после регистрации:</div>
					<ul class='f-left'>
						<li>Личный кабинет</li>
						<li>Документы on-line</li>
						<li>Мои заявки</li>
						<li>Сообщения</li>
					</ul>
