...
<div class='content'>
	<div class='dop_kroshki'>
		<div class='dop_kroshki_ab'>
			...
			<div class='f-left'>/ Восстановление пароля </div>
		</div>
	</div>
	<div class='block-center'>
		<div class='auth recovery_pass'>
			<div class='auth_login'>
				<p class="name_lk">Восстановление пароля</p>				
				<div class='input'>
					<div class="input_left">
						<div class="input_right">
							<div class="input_center">
								<input type='text' name='user'  placeholder='Введите ваш e-mail' />
							</div>
						</div>
					</div>
				</div>
			
				<div class='input auth_login_captcha f-left'>
					<div class="input_left">
						<div class="input_right">
							<div class="input_center">
				...
				<div class='input auth_login_input f-left f-right'>
					<div class="input_left">
						<div class="input_right">
							<div class="input_center">
								<input type='text' id="labelCaptcha" name='Captcha' placeholder='Код с картинки' />
							</div>
						</div>
					</div>
				</div>
			...
			<div class='auth_b_text'>
				После отправки запроса Вам на электронный адрес будет выслана инструкция с дальнейшими действиями для востановления пароля.
			</div>
		</div> <!-- # auth -->
