...
<div class='content'>
	<div class='dop_kroshki'>
		<div class='dop_kroshki_ab'>
			...
			<div class='f-left'>/ Изменение пароля</div>
		</div>
	</div>
	<div class='block-center'>
		<div class='auth recovery_pass'>
			<div class='auth_login'>
				<p class="name_lk">Изменение пароля</p>				
				<div class='input'>
					<div class="input_left">
						<div class="input_right">
							<div class="input_center">
							 	<!-- <label for="labelLoginPas" class="labelLoginPas">Пароль</label> -->
								<input type='text' name='user' placeholder='Пароль' />
							</div>
						</div>
					</div>
				</div>
				...
				<div class='input'>
					<div class="input_left">
						<div class="input_right">
							<div class="input_center">
							 	<!-- <label for="labelLoginPas2" class="labelLoginPas2">Пароль еще раз</label> -->
								<input type='text' name='user' placeholder='Пароль еще раз' />
							</div>
						</div>
					</div>
				</div>
